const slicePage = (data, page, rowsPerPage) => {
...
const startPage = (pageSize, pageNr) => {
...
const entryPage = (dataLength) => {
    return Array.from({length: Math.ceil(dataLength / 10)}, (_, i) => entryProcess(dataLength, 10, i))
}
