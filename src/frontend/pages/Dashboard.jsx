				...
				<div className='uk-child-width-1-3 uk-grid dashboard-gutter' data-uk-grid data-uk-height-match='target: > div > .uk-card'>
					...
					<div>
						<div className='uk-card uk-card-default uk-card-body uk-border-rounded'>
							...
							<Link to='/pages' className='uk-flex uk-flex-middle'>Go to pages<i className='ri-arrow-right-line ri-sm uk-margin-small-left'></i></Link>
						</div>
					</div>
					<div>
						<div className='uk-card uk-card-default uk-card-body uk-border-rounded'>
					...
					<div>
						<div className='uk-card uk-card-default uk-card-body uk-border-rounded'>
							...
							<Link to='/navigation' className='uk-flex uk-flex-middle'>Go to posts<i className='ri-arrow-right-line ri-sm uk-margin-small-left'></i></Link>
						</div>
					</div>
					<div>
						<div className='uk-card uk-card-default uk-card-body uk-border-rounded'>
